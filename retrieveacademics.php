...
<head>
    ...
    <link rel="stylesheet" href="retrieveacademics.css">
        ...
        if(mysqli_num_rows($query_run)>0)
            {
                ...
                <?php
                echo"
                <a class='btn_edit' href='updateacademics.php?student_id={$row['usn']}  && student1_id={$row['course_id']}'>Edit/Update
            ...
            <td >
                <?php 
                echo"
                <a onClick=\"javascript:return confirm('Are You Sure to Delete This');\" class='btn_delete' href='retrieveacademics.php?student_id={$row['usn']} && student1_id={$row['course_id']} '>Delete</a>";
                ?>
                </td>
