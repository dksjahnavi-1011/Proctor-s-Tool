...
<?php
  ...
  if (isset($_POST['btn']))
  {
    ...
    $ins="insert into attendance(usn,sname,dept_id,course_id,course_name,dept_name,pid,pname,total_classes,classes_attended)values('$usn','$name','$dno','$cid','$cname','$dname','$pno','$pname','$tc','$ca')";
...
<form class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return validate()" >
    <table align="center" cellpadding="10">
       ...
       <tr>
            <td>Student Name:</td>
            <td><input type="text" id="name" name="name" placeholder="Enter Student Name" required></td>
       ...
       <tr>
          ...
          <!--  <td><input type="text" id="name" name="cname" placeholder="Enter Course Name" required></td>-->
     ...
     <tr>
       ...
       <tr>
            ...
            <tr>
            <td>Total Classes :</td>
            <td><input type="text" id="name" name="tc" placeholder="Enter Total Classes" required></td>
            ...
            <td><input type="text" id="name" name="ca" placeholder="Enter Classes Attended" required></td>
            ...
            <td><input type="text" id="name" name="per" placeholder="Enter IA-3 Marks" required></td>
