...
<head>
    ...
    <div class="content1">
        <h1 style="right:400px;">View Student Data</h1>
    </div>
        ...
        if(mysqli_num_rows($query_run)>0)
            {
                ...
                <?php
                echo"
                <a class='btn_edit' href='updatestudent.php?student_id={$row['usn']}'>Edit/Update
            ...
            <td >
                <?php 
                echo"
                <a onClick=\"javascript:return confirm('Are You Sure to Delete This');\" class='btn_delete' href='searchstudent.php?student_id={$row['usn']}'>Delete</a>";
                ?>
                </td>
