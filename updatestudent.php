...
<head>
    ...
    <body>
       ...
       <div class="sidebar">
        ...
        <a href="searchstudent"><i class="fa fa-search" ></i><span>View Student</span></a>
    ...
    <div class="content1">
        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return validate()" action="updatestudent.php" >
